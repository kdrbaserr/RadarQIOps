...
| Klasik baseline | `uv run radariq baseline --config configs/baseline.yaml` | Sabit seed/split ile lojistik regresyon çalıştırır; Macro-F1, sınıf recall ve confusion matrix üretir |
